...
<head>
    ...
    <title>Reports - Cashflow Diary</title>
...
<body class="bg-slate-50">
    <main class="p-4 md:p-10">
        <div class="mb-10">
            <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Reports Dashboard</h1>
            <p class="text-slate-500 mt-1">Deep insights and data exports.</p>
        </div>

        <!-- Quick Export Cards -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            <a href="expenses.php" class="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm hover:shadow-xl hover:border-indigo-100 transition-all group">
                ...
                <h3 class="text-lg font-bold text-slate-900">Expense Report</h3>
                <p class="text-sm text-slate-500 mt-1">Full statement with category filters and CSV export.</p>
                <div class="mt-6 flex items-center text-indigo-600 font-bold text-sm">
                    View Report <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" /></svg>
                </div>
            </a>

            <a href="income.php" class="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm hover:shadow-xl hover:border-emerald-100 transition-all group">
                ...
                <h3 class="text-lg font-bold text-slate-900">Income Report</h3>
                <p class="text-sm text-slate-500 mt-1">Track every source of earning with CSV data export.</p>
                <div class="mt-6 flex items-center text-emerald-600 font-bold text-sm">
                    View Report <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" /></svg>
                </div>
            </a>

            <a href="udhaar.php" class="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm hover:shadow-xl hover:border-amber-100 transition-all group">
                ...
                <h3 class="text-lg font-bold text-slate-900">Udhaar Report</h3>
                <p class="text-sm text-slate-500 mt-1">Credit and debt history filtered by contact.</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
            <div class="bg-white p-8 rounded-[2.5rem] border border-slate-100">
                <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">Comparison (Today)</p>
                <div class="space-y-4">
                    <div class="flex justify-between items-center bg-emerald-50 p-4 rounded-2xl">
                        <span class="text-sm font-bold text-emerald-600 uppercase">Income</span>
                        <span class="text-xl font-bold text-emerald-700">+<?php echo format_currency($daily_income); ?></span>
                    </div>
                    <div class="flex justify-between items-center bg-rose-50 p-4 rounded-2xl">
                        <span class="text-sm font-bold text-rose-600 uppercase">Expense</span>
                        <span class="text-xl font-bold text-rose-700">-<?php echo format_currency($daily_expense); ?></span>
                    </div>
                </div>
            </div>

            <div class="lg:col-span-2 bg-white p-8 rounded-[2.5rem] border border-slate-100">
                 <h3 class="text-lg font-bold text-slate-900 mb-6">Income vs Expense Trend</h3>
