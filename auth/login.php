...
<head>
    ...
    <title>Login - Cashflow Diary</title>
...
<body class="bg-slate-50 hero-gradient min-h-screen flex items-center justify-center p-6 select-none">
    <div class="max-w-md w-full glass rounded-[3rem] shadow-2xl shadow-indigo-100/50 overflow-hidden p-10 md:p-12">
        <div class="text-center mb-12">
            ...
            <p class="text-slate-500 mt-3 font-medium">Log in to your account</p>
        </div>
        ...
        <div class="mt-12 text-center">
            <p class="text-sm font-bold text-slate-400">
                New here? 
                <a href="register.php" class="text-indigo-600 hover:text-indigo-700 underline underline-offset-4 decoration-2 decoration-indigo-100 hover:decoration-indigo-600 transition-all">Create Account</a>
            </p>
        </div>
    </div>
</body>
