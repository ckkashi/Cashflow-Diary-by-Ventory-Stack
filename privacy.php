...
<head>
    ...
    <title><?php echo __('privacy_policy', 'Privacy Policy'); ?> - <?php echo __('app_name', 'Cashflow Diary'); ?></title>
...
<body class="bg-slate-50 hero-gradient min-h-screen">
    ...
    <main class="max-w-4xl mx-auto py-20 px-6">
        <div class="glass p-12 md:p-16 rounded-[3rem] shadow-2xl shadow-indigo-100/20">
            <h1 class="text-4xl md:text-5xl font-bold text-slate-900 mb-8"><?php echo __('privacy_policy', 'Privacy Policy'); ?></h1>
            <div class="prose prose-slate prose-lg max-w-none text-slate-600 leading-relaxed space-y-6">
                <p><?php echo __('privacy_desc', 'Your privacy is our priority...'); ?></p>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                <h2 class="text-2xl font-bold text-slate-800 mt-10 mb-4">Data Security</h2>
