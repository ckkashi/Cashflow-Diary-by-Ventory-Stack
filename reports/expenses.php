...
<head>
    ...
    <title>Expense Report - Cashflow Diary</title>
    ...
    <main class="p-4 md:p-10">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4 no-print">
                <div>
                    <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Expense Report</h1>
                    <p class="text-slate-500 mt-1">Detailed breakdown of your spending.</p>
                </div>
...
endforeach; ?>
            ...
            <div class="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm overflow-hidden print-container">
                <div class="p-10 border-b border-slate-100 flex justify-between items-center">
                    <div>
                        <h2 class="text-xl font-bold text-slate-900">Expense Statement</h2>
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-3xl font-bold text-rose-600"><?php echo format_currency($total_amount); ?></p>
                    </div>
                </div>
                    ...
                    <table class="w-full text-left">
                        <thead>
                            <tr class="bg-slate-50 text-slate-400 text-xs font-bold uppercase tracking-wider">
                                ...
                                <th class="px-10 py-4">Category</th>
                                <th class="px-10 py-4">Payment Method</th>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php if (empty($expenses)): ?>
                                <tr>
                                    <td colspan="5" class="px-10 py-20 text-center text-slate-400">No records found for this period.</td>
                                </tr>
                            <?php
else: ?>
                                <?php foreach ($expenses as $row): ?>
                                    <tr class="hover:bg-slate-50 transition-colors">
                                        ...
                                        <td class="px-10 py-4">
                                            <span class="px-3 py-1 bg-slate-100 rounded-full text-xs font-bold text-slate-600"><?php echo e($row['category']); ?></span>
                                        </td>
                                        ...
                                        <td class="px-10 py-4 text-right font-bold text-rose-600">-<?php echo format_currency($row['amount']); ?></td>
                                    </tr>
                                <?php
    endforeach; ?>
                            <?php
