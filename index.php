...
// Include helpers for __() and get_lang_dir()
...
<body class="bg-slate-50 hero-gradient selection:bg-indigo-100 selection:text-indigo-700">
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 p-6">
        <div class="max-w-7xl mx-auto flex justify-between items-center glass p-4 px-8 rounded-3xl shadow-xl shadow-indigo-100/20">
            ...
            <div class="hidden md:flex items-center <?php echo get_lang_dir() === 'rtl' ? 'space-x-reverse' : ''; ?> space-x-8">
                ...
                <a href="login.php" class="bg-slate-900 text-white px-6 py-3 rounded-2xl font-bold hover:bg-indigo-600 transform hover:-translate-y-0.5 transition-all text-sm shadow-lg shadow-slate-200"><?php echo __('login', 'Login'); ?></a>
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div data-aos="fade-right" data-aos-duration="1000">
                ...
                <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 <?php echo get_lang_dir() === 'rtl' ? 'sm:space-x-reverse' : ''; ?> sm:space-x-6">
                    <a href="login.php" class="bg-indigo-600 text-white px-10 py-5 rounded-[2rem] font-bold text-lg hover:bg-indigo-700 transform hover:-translate-y-1 transition-all shadow-2xl shadow-indigo-200 text-center"><?php echo __('get_started_free', 'Get Started Free'); ?></a>
    ...
    <section class="py-32 px-6 text-center">
        <div class="max-w-4xl mx-auto" data-aos="fade-up">
            ...
            <a href="login.php" class="inline-block bg-slate-900 text-white px-12 py-6 rounded-[2.5rem] font-bold text-xl hover:bg-slate-800 transform hover:scale-110 transition-all shadow-2xl"><?php echo __('start_free_today', 'Start for free today'); ?></a>
        </div>
    </section>
    ...
    <footer class="py-20 px-6 border-t border-slate-100 bg-white/50 backdrop-blur-sm">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
            ...
            <div class="flex flex-wrap justify-center md:justify-end items-center gap-6">
                <a href="about.php" class="text-slate-500 hover:text-indigo-600 transition-colors text-sm font-bold"><?php echo __('about_us', 'About Us'); ?></a>
                <a href="privacy.php" class="text-slate-500 hover:text-indigo-600 transition-colors text-sm font-bold"><?php echo __('privacy_policy', 'Privacy Policy'); ?></a>
                <a href="terms.php" class="text-slate-500 hover:text-indigo-600 transition-colors text-sm font-bold"><?php echo __('terms_of_service', 'Terms of Service'); ?></a>
            </div>
